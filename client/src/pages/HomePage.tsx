          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/games" className="hover:text-white transition-colors">베타존</Link></li>
                <li><Link to="/how-it-works" className="hover:text-white transition-colors">플랫폼 소개</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                ...
                <li><Link to="/dashboard" className="hover:text-white transition-colors">개발자 센터</Link></li>
              </ul>
            </div>
            <div>
