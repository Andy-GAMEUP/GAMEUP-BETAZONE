  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        {/* 뒤로가기 */}
        <Link to="/community" className="flex items-center gap-1.5 text-slate-400 hover:text-white text-sm mb-5 transition-colors">
        ...
        <article className="bg-slate-900 border border-slate-800 rounded-xl p-6 mb-4">
          ...
          <div className="flex items-center gap-2 mb-3 flex-wrap">
            ...
            {post.gameId && <Link to={`/games/${post.gameId._id}`} className="bg-cyan-600/20 text-cyan-400 text-xs px-2 py-0.5 rounded hover:bg-cyan-600/40 transition-colors">{post.gameId.title}</Link>}
          </div>
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          ...
          {isAuthenticated ? (
            ...
            <div className="border-t border-slate-800 pt-5 text-center">
              ...
              <Link to="/login" className="bg-cyan-600 hover:bg-cyan-700 text-white text-sm px-4 py-2 rounded-xl transition-colors">로그인</Link>
            </div>
          )}
        </section>
      </div>
