        ...
        {tab === 'favorites' && (
          ...
          favorites.length === 0 ? (
            <div className="text-center py-16 text-slate-500">
              ...
              <p>즐겨찾기한 게임이 없습니다</p>
              <Link to="/games" className="text-cyan-400 hover:text-cyan-300 text-sm mt-2 inline-flex items-center gap-1">
              ...
              {favorites.map((fav) => {
                ...
                return (
                  <div key={fav._id} className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden group hover:border-slate-600 transition-colors">
                    ...
                    <div className="p-3">
                      <Link to={`/games/${g._id}`} className="text-white text-sm font-medium hover:text-cyan-300 transition-colors line-clamp-1">{g.title}</Link>
                ...
                return (
                  <div key={act._id} className="flex items-center gap-3 bg-slate-900 border border-slate-800 rounded-xl p-4 hover:border-slate-700 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {g && (
                        <Link to={`/games/${g._id}`} className="text-slate-400 text-xs hover:text-cyan-300 transition-colors truncate block">
                          {g.title}
                        </Link>
                      )}
                    </div>
