  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <button onClick={() => navigate('/community')} className="flex items-center gap-1.5 text-slate-400 hover:text-white text-sm mb-6 transition-colors">
        ...
        {loading ? (
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-16 text-center">
            ...
            <Link to="/community" className="bg-cyan-600 hover:bg-cyan-700 text-white text-sm px-4 py-2 rounded-xl transition-colors">커뮤니티 둘러보기</Link>
          </div>
        ) : (
