              ...
              {topGames.map((g: any, i: number) => (
                <div key={g._id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link to={`/admin/metrics/${g._id}`} className="text-white text-sm hover:text-cyan-300 truncate block">{g.title}</Link>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <Link key={to} to={to} className={`border rounded-lg p-3 transition-colors ${bg}`}>
